...
class FaceswapGANModel():
    ...
    def build_encoder(nc_in=3,
        ...
        x = Conv2D(64//coef, kernel_size=5, kernel_initializer=kernel_initializer,  use_bias=False, padding="same")(inp) # use_bias should be True
    ...
    def build_decoder(nc_in=512,
        ...
        alpha = Conv2D(1, kernel_size=5, kernel_initializer=kernel_initializer,  padding='same', activation="sigmoid")(x)
        bgr = Conv2D(3, kernel_size=5, kernel_initializer= kernel_initializer, padding='same', activation="tanh")(x)
    ...
    def build_discriminator(nc_in,
        ...
        out = Conv2D(1, kernel_size=4, kernel_initializer=kernel_initializer, use_bias=False, padding="same")(x)  # use_bias should be True
        return Model(inputs=[inp], outputs=out)
